...
class Like {
  ...
  createLike(currentLikeBox) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default().ajax({
      ...
      url: universityData.root_url + '/wp-json/testProject/v1/manageLike',
      type: 'POST',
      data: {
...
class MyNotes {
  ...
  createNote(e) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default().ajax({
      ...
      error: response => {
        if (response.responseText == "You´ve reached your note limit.") {
...
class Search {
  ...
  async getResults() {
    try {
      const response = await axios__WEBPACK_IMPORTED_MODULE_0___default().get(universityData.root_url + "/wp-json/testProject/v1/search?term=" + this.searchField.value);
